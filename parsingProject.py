...
from parsingProjectLexer import parsingProjectLexer
from parsingProjectParser import parsingProjectParser
from parsingProjectListener import parsingProjectListener
import sys
...
def main():
    ...
    lexer = parsingProjectLexer(input_stream)
    stream = antlr4.CommonTokenStream(lexer)
    parser = parsingProjectParser(stream)
