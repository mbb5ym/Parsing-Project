...
/*
* DUE TO ISSUES WITH VERSION CONTROL AND TECHNICAL DIFFICULTIES,
* OUR GROUP DECIDED TO WORK COLLABORATIVELY OVER VIDEO CHAT AND
* COMMIT OUR CODE FROM ONE MACHINE. ALL THE CODE SHOULD HAVE BEEN
* COMMITED BY ADAM MENKER BUT THE ACTUAL CODE ITSELF WAS WRITTEN
* EQUALLY AMONGST OUR GROUP MEMBERS
*/
